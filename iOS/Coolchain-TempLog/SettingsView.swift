...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Coolchain - Temp Log Pro") {
                if purchases.isPro {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/coolchain-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/coolchain-app/terms.html")!)
                Text("Version 1.0")
